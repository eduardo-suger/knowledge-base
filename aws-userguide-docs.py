...
PATH_PREFIX = "/marketplace/latest/userguide"
OUTPUT_DIR = "output"
OUTPUT_FILE = "aws_marketplace_userguide_links.txt"
MAX_DEPTH = 6
...
valid_links = [link for link in visited if link.startswith("https://docs.aws.amazon.com/marketplace/latest/userguide")]
